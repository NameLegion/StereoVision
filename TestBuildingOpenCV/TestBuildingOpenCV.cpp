// TestBuildingOpenCV.cpp: определ€ет точку входа дл€ консольного приложени€.
//

#include "opencvdeps.h"
#include "cv.h"
#include "cxmisc.h"
#include "highgui.h"
//#include "cvaux.h"
...
#define WIDTH 426
#define HEIGHT 320
#define numberofcam1 0
#define numberofcam2 1
...
{//---------Initial--------
	...
	//---------Starting WebCam----------
		capture1= cvCaptureFromCAM(numberofcam1);
		assert(capture1!=NULL); cvWaitKey(100);
		capture2= cvCaptureFromCAM(numberofcam2);
	...
	//--------Find chessboard corner--------------------------------------------------	
        ...
        BMState->uniquenessRatio=15;		// uniquenessRatio > (match_valЦmin_match)/min_match.
